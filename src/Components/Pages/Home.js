            ...
            <div className="px-10 flex z-40">
                ...
                <div className="flex-1 ml-20">
                    <ul className="flex mt-4">
                        ...
                        <li className="ml-10 text-gray-400 hover:text-gray-700" ><a href="#how-it-works">How it works</a></li>
    ...
    return(
        <>
            ...
            <div className="px-10">
                ...
                <div className="pt-10" id="how-it-works">
                ...
                <div className="text-center" id="team">
                    ...
                    <div>
                        <div className="team-card">
                            <div><img className="w-full h-52 bg-no-repeat bg-center bg-cover" src={chatIcon} alt="team_image"/></div>
                            <div className="text-left">
                                <div>Christian Chiemela</div>
            ...
            <div className="border-t-2 border-gray-300 mt-24" id="footer">
                <div className="text-2xl italic text-black-100">
                    <span><svg className="w-14 inline text-red-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z" />
                    </svg></span> 

...
const Home = ({ signInWithGoogle }) => {
    return(
        <>
        <div className="dark:bg-gray-800 h-screen dark:text-gray-300 text-gray-600 bg-gray-50 transition duration-500">
        <Header />
            <div className="px-10 text-6xl w-1/2 mt-5">Only one second to connect to your friends</div>

            <div className="dark:bg-gray-700 bg-white shadow-2xl fixed max-h-screen mt-10 left-10 dark:shadow rounded h-56 text-center dark:text-gray-300 py-5 sm:w-2/3">
            ...
            <div className="absolute bottom-1 right-10 text-sm">All Resrvered @ChristianChiemela Build & Designer 2021</div>
        </div>
        </>
    )
}

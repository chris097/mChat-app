...
export const LoginUser = () => {
    return(
        <>
            <Route path="./Login.js">
                <div className="shadow-2xl absolute left-1/3 w-auto mt-20 px-5 h-auto py-10">
                ...
                <div className="w-96 border-gray-200 border-solid border-2 rounded-md p-2 mt-3"><input type="password" name="password" id="password" placeholder="Password"/></div>
                <div className="w-96 bg-red-400 p-2 mt-3 rounded-md text-center text-white"><button type="submit">LogIn</button></div>
                <div>Have not register <span className="text-red-300 cursor-pointer">click here</span></div>
                </div>
            </Route>
        </>
    )
